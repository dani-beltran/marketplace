...
async function runSeeding() {
  ...
  try {
    ...
    // Insert users
    const clientWallet = await db.wallet.create({
      data: {
        balance: "1000.00",
        user: {
          create: {
    ...
    const contractorWallet = await db.wallet.create({
      data: {
        balance: "0.00",
        user: {
          create: {
    ...
    const clientId = clientWallet.userId;
    const contractorId = contractorWallet.userId;
